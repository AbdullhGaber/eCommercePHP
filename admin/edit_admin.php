...
if (isset($_GET['admin_id'])) {
    ...
    $get_admin_info = "SELECT * FROM admins WHERE admin_id = '$admin_id' ";

    $run_admin = mysqli_query($conn, $get_admin_info);
...
<section class="py-3">
    ...
    <h1 class="text-success text-center">Edit profile</h1>
    ...
    <div class="card-body text-center container py-4">
        <form action="" class="mb-3" enctype="multipart/form-data" method="POST">
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input required type="text" value="<?= $admin_row['admin_name'] ?>" class="form-control " name="admin_name">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input type="email" value="<?= $admin_row['admin_email'] ?>" name="admin_email" class="form-control">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input type="password" value="<?= $admin_row['admin_pass'] ?>" name="admin_password" class="form-control">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-7 ">
                    <img src="admin_images/<?= $admin_row['admin_image'] ?>" height="50" >
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input required type="text" value="<?= $admin_row['admin_contact'] ?>" class="form-control " name="admin_contact">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input required type="text" value="<?= $admin_row['admin_country'] ?>" class="form-control " name="admin_country">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input required type="text" value="<?= $admin_row['admin_job'] ?>" class="form-control " name="admin_job">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <textarea required class="form-control" name="admin_about" cols="9" rows="5"><?= $admin_row['admin_about'] ?></textarea>
                </div>

                
            </div> <!-- admin_about-row-ends -->

            <button type="submit" name="edit_admin" class="btn btn-success">Edit profile</button>
...
WHERE
    ...
    $edit_admin_run = mysqli_query($conn, $edit_admin_sql);
    if ($edit_admin_run) {
