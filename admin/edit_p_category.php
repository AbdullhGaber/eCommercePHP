...
if (isset($_GET['cat_edit'])) {
    $edit_id = $_GET['cat_edit'];

    $get_cat = "SELECT * FROM product_categories WHERE p_cat_id = '$edit_id'";
    ...
    <div class="card-body text-center container py-4">
        ...
        <form action="" class="mb-3" enctype="multipart/form-data" method="POST">
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input required type="text" class="form-control" value="<?= $category_row['p_cat_title'] ?>" name="p_category_title">
                </div>
            ...
            <div class="row g-3 mb-3 align-items-center my-3">
                ...
                <div class="col-9">
                    <input required type="text" class="form-control " value="<?= $category_row['p_cat_desc'] ?>" name="p_category_description">
                </div>

            </div> <!-- category_description-row-ends -->

            <button type="submit" name="edit_category" class="btn btn-success">Edit product category</button>
...
if (isset($_POST['edit_category'])) {
    ...
    $cat_title = $_POST['p_category_title'];
    $category_description = $_POST['p_category_description'];

    $edit_cat = "UPDATE `product_categories` SET `p_cat_title`='$cat_title',`p_cat_desc`='$category_description' WHERE p_cat_id = $edit_id";
